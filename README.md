...
|-------|------:|---------:|----------:|-------:|-----------:|
| **YOLO11n** | 0.942 | 0.660 | 0.905 | 0.899 | 15.1 min |
| **YOLO11s** | 0.951 | 0.685 | 0.919 | 0.887 | 22.8 min |

> Both models trained with rotation/flip augmentation (robust to component orientation). Shipped in `models/` (`best_yolo11n.pt`, `best_yolo11s.pt`) and deployed to the laptop & Raspberry Pi.
